		...
		<div class="col-lg-9" style="margin-left:40px; margin-top:30px; border: none;">
			...
			<div class="tab-content" id="pills-tabContent">
			    <div class="tab-pane fade show active" id="prod" role="tabpanel" aria-labelledby="pills-prod-tab">
			      <p><font size="4"><b><c:out value="${product.productname}" /></b> by <c:out value="${product.brand}" /> &nbsp&nbsp&nbsp</font><i class="fas fa-pen-square"></i></p>
			       <i class="fa fa-star" style="color:grey;"></i>&nbsp <c:out value="${product.rating}" /><br><br>
			       ...
			       <div class="row">
					  ...
					  <div id="myCarousel" class="carousel slide" data-ride="carousel">
					    ...
					    <div class="carousel-inner">
					      <div class="carousel-item active">
					        <img src="images/download1.jfif" alt="Los Angeles" style="width:100%;">
					      ...
					      <div class="carousel-item">
					        <img src="images/download2.jfif" alt="Chicago" style="width:100%;">
					        <div class="carousel-caption">
								<h3>Boracay</h3>
								<p>White Sand Beach.</p>
							</div>
					      ...
					      <div class="carousel-item">
					        <img src="images/download3.jfif" alt="New york" style="width:100%;">
					        <div class="carousel-caption">
								<h3>Boracay</h3>
								<p>White Sand Beach.</p>
							</div>
					...
					<div class="col-lg-3">
						<p><font size="6"><b>Product Description &nbsp</b></font><i class="fas fa-pen-square"></i></p>
							<c:out value="${product.description}" />
						
						<div style="clear:left;">
						<br><br><br><br>
						<p><font size="6"><b>Rs.<c:out value="${product.price}" />/- <c:out value="${product.discount}" />%off&nbsp&nbsp&nbsp</b></font><i class="fas fa-pen-square"></i></p>
					</div>
					</div>
					</div>
						...
						<table class="table table-condensed">
							<thead>
								...
								<tbody>
									<c:forEach var="prod" items="${productinvent}">
									<tr>
			 ...
			 <!---finish and canceal button--->
			 <div>
			 	<form action="/grizzly-store-vendor-web/VendorListProductController">
			 	<div><input type="submit" value="Finish"class="finish" type="submit" name="finish" value="Finish" placeholder="Finish" style="color:#ffffff;"></div><br><br>
			 	<div><input type="submit" value="Cancel"class="cancel" type="submit" name="cancel" value="Cancel" placeholder="Cancel"></div>
			 	</form>
			 </div>
